variable "resource_group_name" {
  type        = string
  description = "Name of the resource group for sandbox ACR"
  default     = "rg-brightcloud-acr-sandbox"
}

variable "location" {
  type        = string
  description = "Azure region for the sandbox registry"
...
variable "public_network_access_enabled" {
  type        = bool
  description = "Enable public network access (more open for sandbox experimentation)"
  default     = true
}
...
variable "retention_policy_days" {
  type        = number
  description = "Number of days to retain untagged manifests in sandbox (shorter for cost optimization)"
  default     = 3
}
...
variable "teams" {
  ...
  description = "Map of teams and their ACR access configuration for sandbox"
  default     = {}
}
...
variable "create_private_endpoint" {
  type        = bool
  description = "Whether to create private endpoint for sandbox registry (typically false)"
  default     = false
}
